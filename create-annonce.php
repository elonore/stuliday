...
<section class="container">
    ...
    <form action="create-annonce-post.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleFormControlInput1" name="title" placeholder="Joli appartement situé en plein centre-ville">
        </div>
        <div class="form-row">
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" id="inputAddress" name="address" placeholder="Adresse complère avec code postal inclus">
            </div>
            <div class="form-group col-md-12">
        ...
        <div class="form-inline">
            <div class="form-group col-md-6">
                ...
                <input type="file" class="form-control-file img-fluid" id="exampleFormControlFile1" name="image_url">
            </div>
            <div class="form-group col-md-6">
        ...
        <div class="form-group my-2">
            <button type="submit" name="submit_annonce" class="btn btn-primary btn-lg">Créer votre annonce!</button>
        </div>
    </form>
</section>
